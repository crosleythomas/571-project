...
for hidden_size in range(hidden_unit_min_size, hidden_unit_max_size, hidden_unit_step_size):
	...
	model_output_file = 'hidden_unit_size_models/' + data_name + '_' + ac_str + '_' + arch_str + '_' + training_timestamp
	...
	dmodel.fit(model_training_input, labels, verbose=1, nb_epoch=2, batch_size=1, validation_split=0.3)
